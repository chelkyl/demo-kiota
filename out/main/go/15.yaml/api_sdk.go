...
// ByPath gets an item from the apiSdk.item collection
// returns a *WithPathItemRequestBuilder when successful
func (m *ApiSdk) ByPath(path string)(*i776acbf65432caf6c0db91bcc9c8db610e54aa3d99a7ca5bd09e5750d12cd79e.WithPathItemRequestBuilder) {
    ...
    return i776acbf65432caf6c0db91bcc9c8db610e54aa3d99a7ca5bd09e5750d12cd79e.NewWithPathItemRequestBuilderInternal(urlTplParams, m.BaseRequestBuilder.RequestAdapter)
}
