...
// ById gets an item from the apiSdk.item.item collection
// returns a *PathItemRequestBuilder when successful
func (m *WithPathItemRequestBuilder) ById(id string)(*PathItemRequestBuilder) {
    ...
    return NewPathItemRequestBuilderInternal(urlTplParams, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *WithPathItemRequestBuilder) Get(ctx context.Context, requestConfiguration *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestConfiguration[i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.DefaultQueryParameters])(*string, error) {
