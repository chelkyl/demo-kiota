...
import (
    i0b889cde0621acbb901b6c104d647352b361702a530062f7953c0910e6ccca7a "apiSdk/foo"
    i776acbf65432caf6c0db91bcc9c8db610e54aa3d99a7ca5bd09e5750d12cd79e "apiSdk/item"
...
// ApiSdk the main entry point of the SDK, exposes the configuration and the fluent API.
type ApiSdk struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// NewApiSdk instantiates a new ApiSdk and sets the default values.
func NewApiSdk(requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ApiSdk) {
    m := &ApiSdk{
    ...
    if m.BaseRequestBuilder.RequestAdapter.GetBaseUrl() == "" {
        m.BaseRequestBuilder.RequestAdapter.SetBaseUrl("https://api.example.com/v1")
    }
...
func (m *ApiSdk) Foo()(*i0b889cde0621acbb901b6c104d647352b361702a530062f7953c0910e6ccca7a.FooRequestBuilder) {
    return i0b889cde0621acbb901b6c104d647352b361702a530062f7953c0910e6ccca7a.NewFooRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// WithPath builds and executes requests for operations under \{path}\
// returns a *WithPathRequestBuilder when successful
func (m *ApiSdk) WithPath()(*i776acbf65432caf6c0db91bcc9c8db610e54aa3d99a7ca5bd09e5750d12cd79e.WithPathRequestBuilder) {
    return i776acbf65432caf6c0db91bcc9c8db610e54aa3d99a7ca5bd09e5750d12cd79e.NewWithPathRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
