...
use ApiSdk\Item\WithPathItemRequestBuilder;
use ApiSdk\Item\WithPathRequestBuilder;
...
class ApiSdk extends BaseRequestBuilder 
{
    ...
    */
    public function withPath(): WithPathRequestBuilder {
        return new WithPathRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
