...
class FooItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/foo/{id}", path_parameters)
    ...
    def with_url(self,raw_url: str) -> FooItemRequestBuilder:
        """
        ...
        return FooItemRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class FooItemRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
