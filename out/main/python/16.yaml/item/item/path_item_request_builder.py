...
class PathItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: str) -> PathItemRequestBuilder:
        """
        ...
        return PathItemRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class PathItemRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
